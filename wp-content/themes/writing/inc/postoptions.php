...
function page_blog_template_options() {
    ...
    asalah_post_options(
            array("name" => __("Number of Posts (Leave blank for default)", 'asalah'),
    ...
    $cats = get_categories();
    $cat_array = array(
      false => __('All Categories', 'asalah')
    );
    foreach ($cats as $cat) {
      $cat_array[$cat->term_id] = $cat->name;
    }
    asalah_post_options(
            array("name" => __("Category", 'asalah'),
...
function asalah_global_options() {
    ...
    asalah_post_options(
            array("name" => __("Sliding Sidebar", 'asalah'),
    ...
    asalah_post_options(
            array("name" => __("Enable Sticky Menu", 'asalah'),
